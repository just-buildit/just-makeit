...
| `_procglobal.py`     | Which component cores reach more than one EXTENSION module, and `process_global = true` — the cross-module rendezvous jm generates into every `PyInit_`; detector and emitter in one file (gh-1117) |
