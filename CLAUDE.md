...
| `_procglobal.py`     | Which component cores reach more than one EXTENSION module, so each `.so` holds its own copy of their file-scope state — linkage only, never a read of your C (gh-1117)          |
