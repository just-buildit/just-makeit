...
Commands:
  new <proj> [dir] [OPTIONS]    Create a new project scaffold.
    ...
    --no-c-prefix               Derive bare C symbols (fir_create), as projects made before
                                gh-1591 do; the default prefixes them with the package name.
    --c-prefix P                Prefix every C symbol jm derives with P_ (`[project] c_prefix`:
                                ...
                                Default: the project name, so `jm new dsp` derives dsp_fir_*.
