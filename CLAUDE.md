...
| `_borrow.py`         | A method that returns a zero-copy view of memory the C state owns — the predicate, which param sizes it, and why a declaration is refused (gh-1312)                                                                                                                         |
